...
IDE_Morph.prototype.createSpriteEditor = function () {
    ...
    if (this.currentTab === 'scripts') {
        ...
        ifrm.setAttribute("src", "https://snap2.ghost.io");
        ...
        div.style.height = document.getElementById('world').height - 150 + "px";

        div.style.position = "relative";
        div.style.top = 140+"px";
...
IDE_Morph.prototype.projectMenu = function () {
    ...
    menu.addItem('Test', function(){
        ...
        dlg.inform('About Snap', 'hello my name is bcc', world);
        dlg.fixLayout();
        dlg.drawNew();
    }, 'test');
    ...
    menu.addItem(
        ...
        function(){
            ...
            var msg, dlg, world;
                myself = this;
            world = myself.world();
            msg = myself.showMessage('Posting project...');
            function onComplete(result){
                ...
                if(result == 'ok'){
                    dlg = new DialogBoxMorph();
                    dlg.inform('Complete posting!', 'this content has been shared on website', world);
                    dlg.fixLayout();
                    dlg.drawNew();
                }
            }
            function getTextURL(url){
                txt = url;
                myself.share.ajaxTest(img, txt, onComplete);
            }
            function getImageURL(url){
                img = url;
                var xml = myself.serializer.serialize(myself.stage);
                myself.share.addText(btoa(xml), getTextURL);
            }
            var png = myself.stage.getThumbnail();
            var base64 = png.substr(png.indexOf(",")+1);
            myself.share.addImage(base64, getImageURL);
        },
        'posting to contents server'
    );
