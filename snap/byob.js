...
ExtensionDialogMorph.prototype.fixLayout = function () {
    ...
    this.icon = new Morph();
    this.icon.texture = 'categori_pic/parrot.png';
    this.icon.drawNew = function () {
        this.image = newCanvas(this.extent(),50,50);
        if (this.texture) {
    ...
    this.icon.drawCachedTexture = function () {
    ...
    this.icon.mouseClickLeft = function () {
        myself.snapMenu();
    };1

    this.icon.color = new Color();
    this.icon.setPosition(new Point(
        150,60));
    this.icon.setExtent(new Point(110, 80));
    this.add(this.icon);
    //image end ////////////////////////////////////////////////
...
/*
    `copy of my fragment object and open an InputSlotDialog on it.
